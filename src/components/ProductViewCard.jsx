...
//         <p className="text-lg font-semibold text-[#C6AC8E]">
//           Price: LKR {product.price.toFixed(2)}
//         </p>
//         <p className="text-gray-600 mt-2">Rating: {product.rating} ★</p>
//         <button className="mt-4 px-6 py-3 bg-gradient-to-r from-[#5E503F] to-[#22333B] text-white rounded-lg shadow hover:opacity-90">
//           Add to Cart
//         </button>
//       </div>
//     </div>
