...
//   price: 49.99,
//   description: 'A beautifully handcrafted wooden vase, blending timeless elegance with modern sophistication.',
...
//   return (
//     <div className="container mx-auto p-6 bg-[#EAE0D3]">
//       <header className="bg-cover bg-center h-60 flex items-center justify-center text-white"
//         style={{ backgroundImage: "url('/assets/images/products-hero.jpg')" }}>
//         <h1 className="text-4xl font-bold bg-black bg-opacity-50 px-6 py-3 rounded-lg">
//           {product.name}
//         </h1>
//       </header>
//       <div className="mt-6">
//         {/* Use ProductViewCard to display the product */}
//         <ProductViewCard product={product} />
//       </div>
//     </div>
//   );
